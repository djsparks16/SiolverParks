...
private:
    ...
    juce::Component oscABox, oscBBox, subBox, noiseBox, filterBox, bassBox, charBox, envBox, lfoBox, matrixBox, fxBox, spaceBox, perfBox, displayBox;
    ...
    SerumKnob reeseAmt, warhornAmt, wompAmt, subharmAmt, comboAmt, stereoWidth, fmAmt, airAmt;
    SerumKnob bodyAmt, growlAmt, shimmerAmt, motionAmt;
    ...
    SerumKnob reverbSize, reverbTone, chorusRate, delayTime;
